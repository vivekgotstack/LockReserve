<div style="background: #1a1a1a; color: #00ff99; padding: 20px; font-family: monospace, Consolas, 'Courier New', monospace; font-size: 1.8rem; font-weight: bold; border-radius: 8px; text-align: center; user-select: none;">
<p align="center" style="background: #1a1a1a; color: #00ff99; padding: 20px; font-family: monospace, Consolas, 'Courier New', monospace; font-size: 2.5rem; font-weight: 900; border-radius: 12px; user-select: none; max-width: 600px; margin: 20px auto;">
  🔐 <strong>LockReserve</strong><br>
  <em style="font-weight: 600; font-size: 1.5rem; color: #99ffbb;">Your Forever Password Vault</em>
</p>
